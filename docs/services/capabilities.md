...
![Aureus capability system board](../../assets/aureus-capability-system.gif)
...
| What we will not fake | ROI promises, accounting correctness, certification, client results, or production readiness without separate evidence |
