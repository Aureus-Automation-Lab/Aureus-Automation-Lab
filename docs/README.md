# Aureus Public Product Library

This folder contains the public product documentation for Aureus Automation Lab.

It is intentionally limited to product, workflow, and public-proof material. It does not contain personal career material, private implementation, local computer paths, or internal generation scripts.
...
2. Open [Offers](products/offers.md).
3. Review the matching product page.
4. Open the relevant public-proof package.
5. Check the [Public boundary](products/public-boundary.md).
