...
For a client-ready one-page version, use the [Aureus Client Use Case Offer Sheet](../use-cases/AUREUS_CLIENT_USE_CASE_OFFER_SHEET.md). For the full sales/showcase copy, use [AUREUS_USE_CASE_SHOWCASE_COPY_V5.md](../use-cases/AUREUS_USE_CASE_SHOWCASE_COPY_V5.md).
