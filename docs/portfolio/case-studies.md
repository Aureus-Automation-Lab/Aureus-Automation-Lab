...
| Public-safe proof | Source-backed FinEcon workflow-family summary, review-state model, Pocket app direction, n8n backend direction, bridge/proof direction, evidence-note example. |
